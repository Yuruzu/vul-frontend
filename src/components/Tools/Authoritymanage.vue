      ...
      <el-table :data="userData" border>
        ...
        <el-table-column fixed="right" label="操作">
          <template slot-scope="scope"><!-- slot-scope="scope" -->
            ...
            <el-button @click.native="getUserId(scope)" type="text" size="small">管理用户工具权限</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-card>
    <!-- -->
    <el-dialog title="管理用户工具权限" :visible.sync="toolsFormVisible">
      <el-row :gutter="20">
        <el-col :span="12">
      ...
      <el-table :data="toolsData" border>
        <el-table-column prop="toolid" label="工具id">
        </el-table-column>
        <el-table-column prop="uploaduser" label="工具上传者">
        </el-table-column>
